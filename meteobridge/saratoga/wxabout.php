...
<?php if($SITE['lang'] == 'en') { ?>  
	...
	<p>The station is powered by a -somekindof- weather station.  The data is collected every X seconds and the site is updated every X minutes. This site and its data is collected using <a href="<?php echo $SITE['WXsoftwareURL']; ?>"><?php echo $SITE['WXsoftwareLongName']; ?></a> Software. The station is comprised of an anemometer, a rain gauge and a thermo-hydro sensor situated in optimal positions for highest accuracy possible.</p>

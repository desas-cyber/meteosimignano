README notes about 2011-11-17 update to add translation settings to all supported languages:

edit your language-LL.txt (where LL= a language supported on your template set) and add
the translation entries for:
...
langlookup|NOT Current|NOT Current|

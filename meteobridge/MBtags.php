...
$rawdatalines = '
date|2025-04-13|// local date:|:
time|11:29:17|// local time:|:
dateUTC|2025-04-13|// UTC date:|:
timeUTC|09:29:17|// UTCtime:|:
...
mbsystem-lastgooddata|27|// seconds passed since last piece of meaningfull sensor data recorded, returns -1 if no sensor data recorded so far:|:
mbsystem-uptime|272711|// uptime of Meteobridge in seconds:|:
...
mbsystem-lunarage|15|// days passes since new moon as integer (example: 28):|:
mbsystem-lunarpercent|99.9|// lunarphase given as percentage from 0% (new moon) to 100% (full moon):|:
...
mbsystem-daylength|13:20|// length of day (example: "11:28"):|:
mbsystem-civildaylength|14:19|// alternative method for daylength computation (example: "12:38"):|:
mbsystem-nauticaldaylength|15:30|// alternative method for daylength computation (example: "14:00"):|:
mbsystem-sunrise|06:36|// time of sunrise in local time. Can be converted to UTC by applying "=utc" to the variable (example: "06:47", resp. "05:47"):|:
mbsystem-sunset|19:56|// time of sunset in local time. Can be converted to UTC by applying "=utc" to the variable (example: "18:15", resp. "17:15"):|:
mbsystem-civilsunrise|06:06|// alternative computation for sunrise.:|:
mbsystem-civilsunset|20:25|// alternative computation for sunset.:|:
mbsystem-nauticalsunrise|05:31|// alternative computation for sunrise.:|:
mbsystem-nauticalsunset|21:01|// alternative alternative computation for sunset..:|:
mbsystem-daynightflag|D|// returns "D" when there is daylight, otherwise "N".:|:
mbsystem-moonrise|20:42|// time of moonrise in local time. Please notice that not every day has a moonrise time, therefore, variable can be non-existent on certain days (example: "05:46", resp. "04:46"):|:
mbsystem-moonset|06:31|// time of moonset in local time. Please notice that not every day has a moonset time, therefore, variable can be non-existent on certain days.:|:
mbsystem-solarmax|850|// maximum possible solar radiation on that day at that point of the earth. Needs latitude and longitude set and pressure data available.:|:
...
th0temp-act|--|// outdoor temperature most recent:|:
th0temp-val5|11.8|// outdoor temperature value 5 minutes ago:|:
th0temp-val10|11.8|// outdoor temperature value 10 minutes ago:|:
th0temp-val15|11.8|// outdoor temperature value 15 minutes ago:|:
th0temp-val30|11.8|// outdoor temperature value 30 minutes ago:|:
th0temp-val60|11.7|// outdoor temperature value 60 minutes ago:|:
th0temp-delta2h|0.6|// outdoor temperature delta 2 hours ago:|:
th0temp-delta3h|1.7|// outdoor temperature delta 3 hours ago:|:
th0temp-delta6h|1.5|// outdoor temperature delta 6 hours ago:|:
th0temp-delta12h|0.2|// outdoor temperature delta 12 hours ago:|:
th0temp-delta24h|-5.6|// outdoor temperature delta 24 hours ago:|:
...
th0temp-hmin|11.8|// outdoor temperature min of this hour:|:
th0temp-hmintime|20250413110019|// outdoor temperature timestamp min of this hour:|:
th0temp-hmax|11.8|// outdoor temperature max of this hour:|:
th0temp-hmaxtime|20250413110019|// outdoor temperature timestamp max of this hour:|:
th0temp-dmin|9.8|// outdoor temperature min of today:|:
th0temp-dmintime|20250413073943|// outdoor temperature timestamp min of today:|:
th0temp-dmax|11.9|// outdoor temperature max of today:|:
th0temp-dmaxtime|20250413105719|// outdoor temperature timestamp max of today:|:
th0temp-ydmin|6.1|// outdoor temperature min of yesterday:|:
th0temp-ydmintime|20250412051652|// outdoor temperature timestamp min of yesterday:|:
th0temp-ydmax|20.5|// outdoor temperature max of yesterday:|:
th0temp-ydmaxtime|20250412144640|// outdoor temperature timestamp max of yesterday:|:
...
th0hum-act|--|// outdoor humidity most recent:|:
th0hum-val5|86|// outdoor humidity value 5 minutes ago:|:
th0hum-val10|86|// outdoor humidity value 10 minutes ago:|:
th0hum-val15|86|// outdoor humidity value 15 minutes ago:|:
th0hum-val30|84|// outdoor humidity value 30 minutes ago:|:
th0hum-val60|85|// outdoor humidity value 60 minutes ago:|:
th0hum-delta2h|0|// outdoor humidity delta 2 hours ago:|:
th0hum-delta3h|-5|// outdoor humidity delta 3 hours ago:|:
th0hum-delta6h|-7|// outdoor humidity delta 6 hours ago:|:
th0hum-delta12h|19|// outdoor humidity delta 12 hours ago:|:
th0hum-delta24h|31|// outdoor humidity delta 24 hours ago:|:
...
th0hum-hmin|86|// outdoor humidity min of this hour:|:
th0hum-hmintime|20250413110019|// outdoor humidity timestamp min of this hour:|:
th0hum-hmax|86|// outdoor humidity max of this hour:|:
th0hum-hmaxtime|20250413110019|// outdoor humidity timestamp max of this hour:|:
th0hum-dmin|63|// outdoor humidity min of today:|:
th0hum-dmintime|20250413000010|// outdoor humidity timestamp min of today:|:
th0hum-dmax|94|// outdoor humidity max of today:|:
th0hum-dmaxtime|20250413060510|// outdoor humidity timestamp max of today:|:
th0hum-ydmin|41|// outdoor humidity min of yesterday:|:
th0hum-ydmintime|20250412151641|// outdoor humidity timestamp min of yesterday:|:
th0hum-ydmax|93|// outdoor humidity max of yesterday:|:
th0hum-ydmaxtime|20250412020716|// outdoor humidity timestamp max of yesterday:|:
...
th0dew-act|--|// outdoor dewpoint most recent:|:
th0dew-val5|9.5|// outdoor dewpoint value 5 minutes ago:|:
th0dew-val10|9.5|// outdoor dewpoint value 10 minutes ago:|:
th0dew-val15|9.5|// outdoor dewpoint value 15 minutes ago:|:
th0dew-val30|9.2|// outdoor dewpoint value 30 minutes ago:|:
th0dew-val60|9.3|// outdoor dewpoint value 60 minutes ago:|:
th0dew-delta2h|0.6|// outdoor dewpoint delta 2 hours ago:|:
th0dew-delta3h|0.8|// outdoor dewpoint delta 3 hours ago:|:
th0dew-delta6h|0.3|// outdoor dewpoint delta 6 hours ago:|:
th0dew-delta12h|3.8|// outdoor dewpoint delta 12 hours ago:|:
th0dew-delta24h|1.2|// outdoor dewpoint delta 24 hours ago:|:
...
th0dew-hmin|9.5|// outdoor dewpoint min of this hour:|:
th0dew-hmintime|20250413110019|// outdoor dewpoint timestamp min of this hour:|:
th0dew-hmax|9.5|// outdoor dewpoint max of this hour:|:
th0dew-hmaxtime|20250413110019|// outdoor dewpoint timestamp max of this hour:|:
th0dew-dmin|4.9|// outdoor dewpoint min of today:|:
th0dew-dmintime|20250413000010|// outdoor dewpoint timestamp min of today:|:
th0dew-dmax|9.6|// outdoor dewpoint max of today:|:
th0dew-dmaxtime|20250413105719|// outdoor dewpoint timestamp max of today:|:
th0dew-ydmin|4.7|// outdoor dewpoint min of yesterday:|:
th0dew-ydmintime|20250412051652|// outdoor dewpoint timestamp min of yesterday:|:
th0dew-ydmax|9.9|// outdoor dewpoint max of yesterday:|:
th0dew-ydmaxtime|20250412125437|// outdoor dewpoint timestamp max of yesterday:|:
...
thb0temp-act|17.2|// indoor temperature most recent:|:
thb0temp-val5|17.2|// indoor temperature value 5 minutes ago:|:
thb0temp-val10|17.2|// indoor temperature value 10 minutes ago:|:
thb0temp-val15|17.2|// indoor temperature value 15 minutes ago:|:
thb0temp-val30|17.1|// indoor temperature value 30 minutes ago:|:
thb0temp-val60|17.2|// indoor temperature value 60 minutes ago:|:
thb0temp-hmin|17.1|// indoor temperature min of this hour:|:
thb0temp-hmintime|20250413110019|// indoor temperature timestamp min of this hour:|:
thb0temp-hmax|17.2|// indoor temperature max of this hour:|:
thb0temp-hmaxtime|20250413110749|// indoor temperature timestamp max of this hour:|:
thb0temp-dmin|17.1|// indoor temperature min of today:|:
thb0temp-dmintime|20250413104018|// indoor temperature timestamp min of today:|:
thb0temp-dmax|19.8|// indoor temperature max of today:|:
thb0temp-dmaxtime|20250413002429|// indoor temperature timestamp max of today:|:
thb0temp-ydmin|16.1|// indoor temperature min of yesterday:|:
thb0temp-ydmintime|20250412000042|// indoor temperature timestamp min of yesterday:|:
thb0temp-ydmax|19.6|// indoor temperature max of yesterday:|:
thb0temp-ydmaxtime|20250412235928|// indoor temperature timestamp max of yesterday:|:
...
thb0temp-mmax|19.8|// indoor temperature max of this month:|:
thb0temp-mmaxtime|20250413002429|// indoor temperature timestamp max of this month:|:
...
thb0hum-act|60|// indoor humidity most recent:|:
thb0hum-val5|60|// indoor humidity value 5 minutes ago:|:
thb0hum-val10|60|// indoor humidity value 10 minutes ago:|:
thb0hum-val15|60|// indoor humidity value 15 minutes ago:|:
thb0hum-val30|60|// indoor humidity value 30 minutes ago:|:
thb0hum-val60|60|// indoor humidity value 60 minutes ago:|:
thb0hum-hmin|60|// indoor humidity min of this hour:|:
thb0hum-hmintime|20250413110019|// indoor humidity timestamp min of this hour:|:
thb0hum-hmax|60|// indoor humidity max of this hour:|:
thb0hum-hmaxtime|20250413110019|// indoor humidity timestamp max of this hour:|:
thb0hum-dmin|53|// indoor humidity min of today:|:
thb0hum-dmintime|20250413000010|// indoor humidity timestamp min of today:|:
thb0hum-dmax|61|// indoor humidity max of today:|:
thb0hum-dmaxtime|20250413092346|// indoor humidity timestamp max of today:|:
thb0hum-ydmin|53|// indoor humidity min of yesterday:|:
thb0hum-ydmintime|20250412234527|// indoor humidity timestamp min of yesterday:|:
thb0hum-ydmax|60|// indoor humidity max of yesterday:|:
thb0hum-ydmaxtime|20250412093730|// indoor humidity timestamp max of yesterday:|:
...
thb0dew-act|9.4|// indoor dewpoint most recent:|:
thb0dew-val5|9.4|// indoor dewpoint value 5 minutes ago:|:
thb0dew-val10|9.4|// indoor dewpoint value 10 minutes ago:|:
thb0dew-val15|9.4|// indoor dewpoint value 15 minutes ago:|:
thb0dew-val30|9.3|// indoor dewpoint value 30 minutes ago:|:
thb0dew-val60|9.4|// indoor dewpoint value 60 minutes ago:|:
thb0dew-hmin|9.3|// indoor dewpoint min of this hour:|:
thb0dew-hmintime|20250413110019|// indoor dewpoint timestamp min of this hour:|:
thb0dew-hmax|9.4|// indoor dewpoint max of this hour:|:
thb0dew-hmaxtime|20250413110749|// indoor dewpoint timestamp max of this hour:|:
thb0dew-dmin|9.1|// indoor dewpoint min of today:|:
thb0dew-dmintime|20250413020632|// indoor dewpoint timestamp min of today:|:
thb0dew-dmax|9.9|// indoor dewpoint max of today:|:
thb0dew-dmaxtime|20250413001128|// indoor dewpoint timestamp max of today:|:
thb0dew-ydmin|7.6|// indoor dewpoint min of yesterday:|:
thb0dew-ydmintime|20250412020016|// indoor dewpoint timestamp min of yesterday:|:
thb0dew-ydmax|9.9|// indoor dewpoint max of yesterday:|:
thb0dew-ydmaxtime|20250412234327|// indoor dewpoint timestamp max of yesterday:|:
...
thb0dew-mmax|9.9|// indoor dewpoint max of this month:|:
thb0dew-mmaxtime|20250412234327|// indoor dewpoint timestamp max of this month:|:
...
thb0press-act|966.7|// station pressure most recent:|:
thb0press-val5|966.8|// station pressure value 5 minutes ago:|:
thb0press-val10|966.9|// station pressure value 10 minutes ago:|:
thb0press-val15|966.7|// station pressure value 15 minutes ago:|:
thb0press-val30|966.8|// station pressure value 30 minutes ago:|:
thb0press-val60|966.6|// station pressure value 60 minutes ago:|:
thb0press-hmin|966.5|// station pressure min of this hour:|:
thb0press-hmintime|20250413111219|// station pressure timestamp min of this hour:|:
thb0press-hmax|967.0|// station pressure max of this hour:|:
thb0press-hmaxtime|20250413110519|// station pressure timestamp max of this hour:|:
thb0press-dmin|966.0|// station pressure min of today:|:
thb0press-dmintime|20250413063040|// station pressure timestamp min of today:|:
thb0press-dmax|967.6|// station pressure max of today:|:
thb0press-dmaxtime|20250413002129|// station pressure timestamp max of today:|:
thb0press-ydmin|966.9|// station pressure min of yesterday:|:
thb0press-ydmintime|20250412202251|// station pressure timestamp min of yesterday:|:
thb0press-ydmax|970.0|// station pressure max of yesterday:|:
thb0press-ydmaxtime|20250412000942|// station pressure timestamp max of yesterday:|:
...
thb0seapress-act|966.7|// sealevel pressure most recent:|:
thb0seapress-val5|966.8|// sealevel pressure value 5 minutes ago:|:
thb0seapress-val10|966.9|// sealevel pressure value 10 minutes ago:|:
thb0seapress-val15|966.7|// sealevel pressure value 15 minutes ago:|:
thb0seapress-val30|966.8|// sealevel pressure value 30 minutes ago:|:
thb0seapress-val60|966.6|// sealevel pressure value 60 minutes ago:|:
thb0seapress-delta2h|0.4|// sealevel pressure delta 2 hours ago:|:
thb0seapress-delta3h|0.5|// sealevel pressure delta 3 hours ago:|:
thb0seapress-delta6h|-0.4|// sealevel pressure delta 6 hours ago:|:
thb0seapress-delta12h|-0.9|// sealevel pressure delta 12 hours ago:|:
thb0seapress-delta24h|-2.7|// sealevel pressure delta 24 hours ago:|:
...
thb0seapress-hmin|966.5|// sealevel pressure min of this hour:|:
thb0seapress-hmintime|20250413111219|// sealevel pressure timestamp min of this hour:|:
thb0seapress-hmax|967.0|// sealevel pressure max of this hour:|:
thb0seapress-hmaxtime|20250413110519|// sealevel pressure timestamp max of this hour:|:
thb0seapress-dmin|966.0|// sealevel pressure min of today:|:
thb0seapress-dmintime|20250413063040|// sealevel pressure timestamp min of today:|:
thb0seapress-dmax|967.6|// sealevel pressure max of today:|:
thb0seapress-dmaxtime|20250413002129|// sealevel pressure timestamp max of today:|:
thb0seapress-ydmin|966.9|// sealevel pressure min of yesterday:|:
thb0seapress-ydmintime|20250412202251|// sealevel pressure timestamp min of yesterday:|:
thb0seapress-ydmax|970.0|// sealevel pressure max of yesterday:|:
thb0seapress-ydmaxtime|20250412000942|// sealevel pressure timestamp max of yesterday:|:
thb0seapress-mmin|966.0|// sealevel pressure min of this month:|:
thb0seapress-mmintime|20250413063040|// sealevel pressure timestamp min of this month:|:
...
wind0wind-act|2.0|// windspeed most recent:|:
wind0wind-val5|2.6|// windspeed value 5 minutes ago:|:
wind0wind-val10|2.6|// windspeed value 10 minutes ago:|:
wind0wind-val15|3.6|// windspeed value 15 minutes ago:|:
wind0wind-val30|2.6|// windspeed value 30 minutes ago:|:
wind0wind-val60|2.6|// windspeed value 60 minutes ago:|:
wind0wind-hmin|2.0|// windspeed min of this hour:|:
wind0wind-hmintime|20250413111149|// windspeed timestamp min of this hour:|:
wind0wind-hmax|3.6|// windspeed max of this hour:|:
wind0wind-hmaxtime|20250413111350|// windspeed timestamp max of this hour:|:
wind0wind-dmin|0.0|// windspeed min of today:|:
wind0wind-dmintime|20250413012231|// windspeed timestamp min of today:|:
wind0wind-dmax|6.1|// windspeed max of today:|:
wind0wind-dmaxtime|20250413073943|// windspeed timestamp max of today:|:
wind0wind-ydmin|0.0|// windspeed min of yesterday:|:
wind0wind-ydmintime|20250412001042|// windspeed timestamp min of yesterday:|:
wind0wind-ydmax|8.2|// windspeed max of yesterday:|:
wind0wind-ydmaxtime|20250412164114|// windspeed timestamp max of yesterday:|:
...
wind0avgwind-act|1.1|// average windspeed most recent:|:
wind0avgwind-val5|1.3|// average windspeed value 5 minutes ago:|:
wind0avgwind-val10|1.7|// average windspeed value 10 minutes ago:|:
wind0avgwind-val15|1.7|// average windspeed value 15 minutes ago:|:
wind0avgwind-val30|0.5|// average windspeed value 30 minutes ago:|:
wind0avgwind-val60|2.4|// average windspeed value 60 minutes ago:|:
wind0avgwind-delta2h|0.0|// average windspeed delta 2 hours ago:|:
wind0avgwind-delta3h|-0.8|// average windspeed delta 3 hours ago:|:
wind0avgwind-delta6h|1.1|// average windspeed delta 6 hours ago:|:
wind0avgwind-delta12h|1.1|// average windspeed delta 12 hours ago:|:
wind0avgwind-delta24h|0.1|// average windspeed delta 24 hours ago:|:
...
wind0avgwind-hmin|0.4|// average windspeed min of this hour:|:
wind0avgwind-hmintime|20250413111650|// average windspeed timestamp min of this hour:|:
wind0avgwind-hmax|2.4|// average windspeed max of this hour:|:
wind0avgwind-hmaxtime|20250413110049|// average windspeed timestamp max of this hour:|:
wind0avgwind-dmin|0.0|// average windspeed min of today:|:
wind0avgwind-dmintime|20250413002059|// average windspeed timestamp min of today:|:
wind0avgwind-dmax|4.2|// average windspeed max of today:|:
wind0avgwind-dmaxtime|20250413070542|// average windspeed timestamp max of today:|:
wind0avgwind-ydmin|0.0|// average windspeed min of yesterday:|:
wind0avgwind-ydmintime|20250412000212|// average windspeed timestamp min of yesterday:|:
wind0avgwind-ydmax|5.4|// average windspeed max of yesterday:|:
wind0avgwind-ydmaxtime|20250412164114|// average windspeed timestamp max of yesterday:|:
...
wind0dir-act|110|// wind direction most recent:|:
wind0dir-val5|108|// wind direction value 5 minutes ago:|:
wind0dir-val10|104|// wind direction value 10 minutes ago:|:
wind0dir-val15|109|// wind direction value 15 minutes ago:|:
wind0dir-val30|78|// wind direction value 30 minutes ago:|:
wind0dir-val60|111|// wind direction value 60 minutes ago:|:
...
wind0dir-avg10|98|// wind direction average 10 minutes:|:
wind0dir-havg|100|// wind direction average of this hour:|:
wind0dir-davg|111|// wind direction average of today:|:
wind0dir-ydavg|140|// wind direction average of yesterday:|:
wind0dir-mavg|156|// wind direction average of this month:|:
wind0dir-yavg|158|// wind direction average of this year:|:
wind0dir-aavg|158|// wind direction average of all time:|:
wind0dir-starttime|20250216011134|// wind direction timestamp of first recorded data:|:
wind0chill-act|11.3|// outdoor wind chill temperature most recent:|:
wind0chill-val5|10.9|// outdoor wind chill temperature value 5 minutes ago:|:
wind0chill-val10|10.9|// outdoor wind chill temperature value 10 minutes ago:|:
wind0chill-val15|10.4|// outdoor wind chill temperature value 15 minutes ago:|:
wind0chill-val30|10.9|// outdoor wind chill temperature value 30 minutes ago:|:
wind0chill-val60|10.8|// outdoor wind chill temperature value 60 minutes ago:|:
wind0chill-hmin|10.4|// outdoor wind chill temperature min of this hour:|:
wind0chill-hmintime|20250413111350|// outdoor wind chill temperature timestamp min of this hour:|:
wind0chill-hmax|11.3|// outdoor wind chill temperature max of this hour:|:
wind0chill-hmaxtime|20250413111149|// outdoor wind chill temperature timestamp max of this hour:|:
wind0chill-dmin|6.9|// outdoor wind chill temperature min of today:|:
wind0chill-dmintime|20250413073943|// outdoor wind chill temperature timestamp min of today:|:
wind0chill-dmax|11.7|// outdoor wind chill temperature max of today:|:
wind0chill-dmaxtime|20250413000028|// outdoor wind chill temperature timestamp max of today:|:
wind0chill-ydmin|4.3|// outdoor wind chill temperature min of yesterday:|:
wind0chill-ydmintime|20250412054923|// outdoor wind chill temperature timestamp min of yesterday:|:
wind0chill-ydmax|20.5|// outdoor wind chill temperature max of yesterday:|:
wind0chill-ydmaxtime|20250412144640|// outdoor wind chill temperature timestamp max of yesterday:|:
...
uv0index-act|1.0|// uv index most recent:|:
...
uv0index-hmintime|20250413110049|// uv index timestamp min of this hour:|:
uv0index-hmax|1.0|// uv index max of this hour:|:
uv0index-hmaxtime|20250413112750|// uv index timestamp max of this hour:|:
uv0index-dmin|0.0|// uv index min of today:|:
uv0index-dmintime|20250413000010|// uv index timestamp min of today:|:
uv0index-dmax|1.0|// uv index max of today:|:
uv0index-dmaxtime|20250413112750|// uv index timestamp max of today:|:
uv0index-ydmin|0.0|// uv index min of yesterday:|:
uv0index-ydmintime|20250412000003|// uv index timestamp min of yesterday:|:
uv0index-ydmax|5.0|// uv index max of yesterday:|:
uv0index-ydmaxtime|20250412134038|// uv index timestamp max of yesterday:|:
...
sol0rad-act|254|// solar rad most recent:|:
sol0rad-val5|108|// solar rad value 5 minutes ago:|:
sol0rad-val10|92|// solar rad value 10 minutes ago:|:
sol0rad-val15|149|// solar rad value 15 minutes ago:|:
sol0rad-val30|97|// solar rad value 30 minutes ago:|:
sol0rad-val60|145|// solar rad value 60 minutes ago:|:
sol0rad-hmin|90|// solar rad min of this hour:|:
sol0rad-hmintime|20250413112050|// solar rad timestamp min of this hour:|:
sol0rad-hmax|254|// solar rad max of this hour:|:
sol0rad-hmaxtime|20250413112850|// solar rad timestamp max of this hour:|:
sol0rad-dmin|0|// solar rad min of today:|:
sol0rad-dmintime|20250413000010|// solar rad timestamp min of today:|:
sol0rad-dmax|254|// solar rad max of today:|:
sol0rad-dmaxtime|20250413112850|// solar rad timestamp max of today:|:
sol0rad-ydmin|0|// solar rad min of yesterday:|:
sol0rad-ydmintime|20250412000003|// solar rad timestamp min of yesterday:|:
sol0rad-ydmax|890|// solar rad max of yesterday:|:
sol0rad-ydmaxtime|20250412142710|// solar rad timestamp max of yesterday:|:
...
th0heatindex-act|--|// outdoor heat index most recent:|:
th0heatindex-val5|11.8|// outdoor heat index value 5 minutes ago:|:
th0heatindex-val10|11.8|// outdoor heat index value 10 minutes ago:|:
th0heatindex-val15|11.8|// outdoor heat index value 15 minutes ago:|:
th0heatindex-val30|11.8|// outdoor heat index value 30 minutes ago:|:
th0heatindex-val60|11.7|// outdoor heat index value 60 minutes ago:|:
th0heatindex-hmin|11.8|// outdoor heat index min of this hour:|:
th0heatindex-hmintime|20250413110019|// outdoor heat index timestamp min of this hour:|:
th0heatindex-hmax|11.8|// outdoor heat index max of this hour:|:
th0heatindex-hmaxtime|20250413110019|// outdoor heat index timestamp max of this hour:|:
th0heatindex-dmin|9.8|// outdoor heat index min of today:|:
th0heatindex-dmintime|20250413073943|// outdoor heat index timestamp min of today:|:
th0heatindex-dmax|11.9|// outdoor heat index max of today:|:
th0heatindex-dmaxtime|20250413105719|// outdoor heat index timestamp max of today:|:
th0heatindex-ydmin|6.1|// outdoor heat index min of yesterday:|:
th0heatindex-ydmintime|20250412051652|// outdoor heat index timestamp min of yesterday:|:
th0heatindex-ydmax|20.5|// outdoor heat index max of yesterday:|:
th0heatindex-ydmaxtime|20250412144640|// outdoor heat index timestamp max of yesterday:|:
...
wind0dir-min10|69|// wind direction min 10 minutes:|:
wind0dir-max10|128|// wind direction max 10 minutes:|:

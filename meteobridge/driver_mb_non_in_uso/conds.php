...
// Version 1.06 - 05-Sep-2016 - added option for curforecast.txt as scrolling forecast
// Version 1.07 - 09-Apr-2020 - added fail message if input data incomplete
// Version 1.08 - 26-Jan-2022 - fixes for PHP 8.1
// Version 1.09 - 176-Jun-2023 - fixes for PHP 8.2
$Version = "conds.php Version 1.09 - 20-Jun-2023";
...
$curForecastFile = 'curforecast.txt';   // optional forecast file (text only)
...
if(file_exists($curForecastFile)) {
   $curForecastText = file_get_contents($curForecastFile);
   if(strlen($curForecastText) > 10) { // got it.. do it.
     // also, change naked " to \" in string for happy JSON coding.
     $JSONdata["forecast"] = 'NWS Current Forecast: '.str_replace('"','\"',$curForecastText);
   }
} else {
  $JSONdata["forecast"] = 'Conditions updated: '.$Data[1]; 
  // WD Sample= 'increasing clouds and warmer.precipitation possible within 12 to 24 hrs. windy.'
}

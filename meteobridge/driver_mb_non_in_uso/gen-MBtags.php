...
// Version 1.04 - 26-Jan-2022 - added additional available meteobridge variables
// Version 1.05 - 20-Jun-2023 - additional variables added by meteoalmendralejo.es for MB-trends-inc
// --------------------------------------------------------------------------
// allow viewing of generated source
$Version = 'gen-MBtags.php - V1.05 - 20-Jun-2023';
...
$Sensors = array(
  ...
  'uv0index|.1|uv index',
  'sol0rad|.0|solar rad',
  'sol0evo|evo|solar evo', // Añadido por AGallardo
);
$UOM = array();
/*
...
$UOM['evo'] = (preg_match('|in|i',$uomRain))?'=in.3':'.2'; // Añadido por AGallardo
...
print_start();
#
# generate tags for some builtin variables that don't match tag names //Añadidas variables por AGallardo
#
$Builtins = array(
  ...
  'mbsystem-station'   => '[mbsystem-station:--]|string that specifies selected weather station (expample: "WMR-200")',
  ...
  'mbsystem-lastgooddata'   => '[mbsystem-lastgooddata:--]|seconds passed since last piece of meaningfull sensor data recorded, returns -1 if no sensor data recorded so far',
  'mbsystem-uptime'   => '[mbsystem-uptime:--]|uptime of Meteobridge in seconds',
  'mbsystem-cpuload1m' => '[mbsystem-cpuload1m:--]|shows average cpu load during last 1 minute',
  'mbsystem-cpuload5m' => '[mbsystem-cpuload5m:--]|shows average cpu load during last 5 minutes',
  'mbsystem-cpuload15m' => '[mbsystem-cpuload15m:--]|shows average cpu load during last 15 minutes',
  ...
  'mbsystem-solarmax' => '[mbsystem-solarmax:--]|maximum possible solar radiation on that day at that point of the earth. Needs latitude and longitude set and pressure data available.',
  'forecast-rule' => '[forecast-rule:--]|Davis forecast rule number',
  'forecast-text' => '[forecast-text:]|Davis forecast reports in English',
  'forecast-texteshtml' => '[forecast-texteshtml:]|Davis forecast reports in Spanish',
);

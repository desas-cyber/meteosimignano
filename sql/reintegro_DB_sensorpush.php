...
// CONTROLLO SICUREZZA
// ============================================================================
// Verifica token di sicurezza nell'URL (es: reintegro_db_sensor_push.php?token=abc123)
...
try {
    ...
    // ========================================================================
    $csvPath = __DIR__ . "/sensor_push_backup.csv";
    ...
    $start = '2026-06-16 00:01:00';
    $end   = '2026-08-28 00:01:59';

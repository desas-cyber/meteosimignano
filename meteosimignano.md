...
|--- meteobridge (interfaccia con stazione meteo che invia i dati in formato get)
|           |--- tabella_home.php (legge i dati dale get di meteobridge per la tabela in index.php)
|           |--- tabella_mete_DB_simignano.php (aggiorna il db da chiamata get di meteobridge)
|           |--- dati_temperatura.txt (stringa di servizio scritta da tabella_home.php)
|
